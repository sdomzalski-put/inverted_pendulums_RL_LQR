...
register(
    id='CustomInvPend-v4',
    entry_point='gym.envs.myfigures:CustomInvPendEnv4',
...
register(
    id='DoubleInvPend-v1',
    entry_point='gym.envs.myfigures:DoubleInvPendV1',
    max_episode_steps=2000,
    reward_threshold=195.0,
)

register(
    id='ParallelInvPend-v1',
    entry_point='gym.envs.myfigures:ParallelInvPendV1',
    max_episode_steps=2000,
    reward_threshold=195.0,
)
